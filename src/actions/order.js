...
export const AddOrder = (formData) => async (dispatch) => {
    ...
    try {
      const res = await axios.post(
        "https://finaldeployeldebou.herokuapp.com/api/order",
        formData,
        config
      );
...
export const getOrdersFree = () => async (dispatch) => {
  try {
    const res = await axios.get(`https://finaldeployeldebou.herokuapp.com/api/order/all-orders-without-delivery`);
...
export const ReserveOrder = (id) => async (dispatch) => {
  try {
    const res = await axios.put( `https://finaldeployeldebou.herokuapp.com/api/order/reserve-order/${id}`,
...
export const CondirmedState = ( id) => async (dispatch) => {
  try {
    const res = await axios.put( `https://finaldeployeldebou.herokuapp.com/api/order/state-order/${id}`);
...
export const MyOrdersDelivery = () => async (dispatch) => {
  try {
    const res = await axios.get(`https://finaldeployeldebou.herokuapp.com/api/order/myorders`);
...
export const AddOrderExchange = (id,idproposition) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `https://finaldeployeldebou.herokuapp.com/api/propositions/acceptExchange/${id}/${idproposition}`,
...
export const ReserveOrderDonation = (id) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `https://finaldeployeldebou.herokuapp.com/api/order/reservationdonation/${id}`,  
    );
