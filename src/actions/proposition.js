  ...
  export const AddProposition = (id,formData) => async (dispatch) => {
    ...
    try {
      const res = await axios.post(`https://finaldeployeldebou.herokuapp.com/api/propositions/${id}`,
      formData
  ...
  export const getPropositions = (id) => async (dispatch) => {
    try {
        const res = await axios.get(`https://finaldeployeldebou.herokuapp.com/api/propositions/${id}`);
  ...
  export const DeleteProposition = (id) => async (dispatch) => {
    try {
        await axios.delete(`https://finaldeployeldebou.herokuapp.com/api/propositions/${id}`);
