...
function Chatbot() {
    ...
    const textQuery = async (text) => {
        ...
        try {
            ...
            const response = await Axios.post('https://finaldeployeldebou.herokuapp.com/api/dialogflow/dialogflow', textQueryVariables)
    ...
    const eventQuery = async (event) => {
        ...
        try {
            //I will send request to the textQuery ROUTE 
            const response = await Axios.post('https://finaldeployeldebou.herokuapp.com/api/dialogflow/eventQuery', eventQueryVariables)
